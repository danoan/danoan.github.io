...
$(document).ready(function () {
  $('a.panel-button').click(function (e) {
    ...
    */
    ...
    if (e.target.title==="List of Projects") {
        document.getElementById("timeline-papers").style.display="None";
        document.getElementById("timeline-projects").style.display="Block";
    }else if (e.target.title==="List of Papers") {
        document.getElementById("timeline-papers").style.display="Block";
        document.getElementById("timeline-projects").style.display="None";
    }
  ...
  }else if (window.location.hash && window.location.hash == '#papers') {
    document.getElementById("timeline-papers").style.display="Block";
    document.getElementById("timeline-projects").style.display="None";
    $('a.panel-button').click();
  }
